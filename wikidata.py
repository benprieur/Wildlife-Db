WIKIDATA_REQUEST1 = """SELECT DISTINCT ?item ?itemLabel ?nomscientifique ?rangtaxinomique ?rangtaxinomiqueLabel ?taxonsuperieur ?taxonsuperieurLabel ?citesid ?image ?value ?valueLabel
WHERE
{
